...
function renderAddProductModal() {
  ...
  <div id="modal-backdrop" class="modal-backdrop" style="z-index:130;align-items:flex-start;padding:24px 12px;">
    <div style="display:flex;gap:18px;width:100%;max-width:980px;align-items:flex-start;">
      ...
      <!-- ── Vista previa ── -->
      <div id="product-preview-panel" style="width:270px;flex-shrink:0;position:sticky;top:24px;">
        ...
        <div id="product-preview-card" style="background:var(--surface,#17181e);border:1px solid var(--border-subtle,rgba(255,255,255,0.07));border-radius:13px;overflow:hidden;animation:slideUp .25s cubic-bezier(.2,.9,.2,1);">
          <!-- Imagen -->
